...
function reachAnswer(question) {
  ...
  if (reachHas(q, ["founded", "founder", "satyam", "gabriel", "ceo", "cofounder", "co-founder", "shivam", "brother", "story", "youngest"])) {
    return "ReachEquilibria was founded by Satyam Sood and Gabriel Wang during their sophomore year at 15-16 yrs old. Satyam Sood is the CEO and CoFounder, and Gabriel Wang is the COO and CoFounder. The story page explains that Reach Equilibria was founded after Satyam experienced the devastating loss of his older brother, Shivam Sood. Open " + reachLinks([["about/index.html#purpose", "About"], ["about/index.html#meet-the-team", "Meet The Team"], ["our-story/index.html", "Our Story"], ["satyam-sood/index.html", "Full Team Page"]]) + ".";
  }
  ...
  if (reachHas(q, ["team", "trinity", "dhanushi", "johan", "fay", "daniel", "immanuel", "officer", "director"])) {
    return "For leadership and team information, open " + reachSiteLink("about/index.html#meet-the-team", "Meet The Team") + " or " + reachSiteLink("satyam-sood/index.html", "the full team page") + ". For verification, email verify@reachequilibria.org.";
  }
